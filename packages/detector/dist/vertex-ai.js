...
const VERTEX_ENDPOINT = "https://us-east1-aiplatform.googleapis.com/v1/projects/solarb-project/locations/us-east1/endpoints/3010500220246032384:predict";
 ...
 */
export async function predictAnomaly(instances) {
    ...
    if (!response.ok) {
        ...
        throw new Error(`Vertex AI request failed: ${response.status} ${response.statusText} ${body}`);
    }
